    ...
    <section class="activities-page">
        <div class="container">
            ...
            <ul class="activities-list">
                <li class="activities-item"><a href="2026AIEngineerCamp_zh.jsp"><i class="far fa-calendar-check"></i><span>中加青少年AI未来工程师研学活动·7天沉浸式挑战<span class="activities-tag">研学营</span></span></a></li>
                ...
                <li class="activities-item"><a href="2026-motherArtPoetry_zh.jsp"><i class="far fa-calendar-check"></i><span>母亲节艺术展暨诗歌朗诵会<span class="activities-tag">社区活动</span></span></a></li>

...
3. 如果因组织方原因本次游学活动取消，100%全款退还。<br/><br/>
 ...
 <div class="text-muted" style="font-size: 20px;">
    ...
    <section class="page-section" style="margin-top: 10px;">   
        <div class="container">
            <div>
                 <span style="color: #323edb; font-size: 18px;">活动说明</span>&nbsp;
            </div>
 ...
 <h2>研学城市</h2>
  ...
  <h2>课程背景</h2>
  <p>
    在华夏大地南端，岭南文化熠熠生辉，广州、深圳、潮州、汕头四座城市，宛如四颗明珠，交相辉映，
    共同诉说着岭南文化的独特魅力，诚邀你来开启这场难忘的文化之旅。
  </p>

  <h3>广州</h3>
  <p>
    广州，作为岭南文化的重要发祥地，千年商都底蕴深厚。踏入陈家祠，木雕、砖雕、石雕、陶塑、灰塑等“岭南七绝”映入眼帘，
    精美绝伦，每一处细节都承载着岁月的痕迹，展现着古人的匠心独运。镇海楼屹立在越秀山上，见证着广州的沧桑变迁，
    登顶俯瞰，城市的繁华与历史的厚重尽收眼底。粤剧婉转的唱腔悠悠飘荡，演员们的一颦一笑、一招一式，
    尽显“南国红豆”的独特韵味。还有那丰富多样的早茶文化，虾饺、肠粉、叉烧包等精致茶点，
    是广州人生活的仪式感，也是岭南饮食文化的鲜活体现。
  </p>
  <p>岭南即是中国对外开放最早的地方，也是著名的侨乡，东西方文化交融也是岭南文化的特色。</p>

  <h3>深圳</h3>
  <p>
    深圳，这座充满创新活力的现代都市，在飞速发展中也保留着岭南文化的根脉。南头古城，有着近1700年历史，
    斑驳的城墙和古旧的街巷，是岁月留下的故事。漫步其中，传统与现代完美融合，古老建筑旁是充满创意的文创小店，
    历史与现代在这里碰撞出奇妙的火花。你既能感受到现代都市的蓬勃朝气，又能领略到岭南文化在新时代的创新与传承。
  </p>

  <h3>潮州</h3>
  <p>
    潮州，素有“岭海名邦”“海滨邹鲁”的美誉，古城建制已超1600多年，是潮州文化的核心承载地。
    广济桥横卧韩江之上，集梁桥、浮桥、拱桥于一体，独特的建筑风格和悠久的历史，使其成为中国四大古桥之一。
    潮州还是非遗的宝库：潮州木雕以其精湛技艺闻名遐迩，潮绣针法多变、绣品华丽，潮州工夫茶艺更被列入
    联合国教科文组织非遗代表作名录。美食方面，牛肉丸、蚝烙、鸭母捻、粿汁等小吃都展现出独特的潮州风味。
  </p>

  <h3>汕头</h3>
  <p>
    汕头，小公园开埠区是这座城市的历史记忆。骑楼建筑独具南洋风情，仿佛让人穿越回商贸繁盛的年代。
    英歌舞是汕头特色的民俗活动，舞者们动作刚劲有力、气势恢宏，展现了汕头人民的热情与豪迈。
    汕头美食同样丰富：卤鹅、牛肉火锅、潮汕肠粉、粿品等，令人垂涎欲滴。
  </p>

  <h3>泉州</h3>
  <p>
    泉州，不是一座需要“参观”的博物馆，而是一处值得“沉浸”的生活场。青石板路、古早味小吃、南音吟唱，
    都藏着宋元大港的繁华余韵与闽南文化的肌理。九日山祈风石刻、开元寺钟声、西街骑楼、蟳埔女簪花，
    构成了泉州独特的文化风景。这座被联合国教科文组织认证为“世界海洋商贸中心”的古城，
    用千年历史和鲜活的烟火气诉说着“此地古称佛国，满街都是圣人”的传奇。
  </p>

  <h3>厦门</h3>
  <p>
    厦门，简称“厦”或“鹭”，别称鹭岛，是福建省地级市、副省级市、计划单列市。
    位于中国东南沿海，与台湾一水相连，犹如一颗璀璨的明珠，闪耀在东海之畔。
  </p>

  <h2>接待单位</h2>
  <p>
    “中学生学习报”以及“全球文化教育交流协会”将派出专业老师带领并指导研学活动，
    学员将从历史脉络、文化传承、风俗习惯等方面得到全面和深入的了解与提升。
  </p>
    ...
    <section class="page-section" style="margin-top: 10px;">   
        <div class="container">
            <div>
                 <span style="color: #323edb; font-size: 18px;">活动安排</span>&nbsp;
            </div>
            
            <div><h2><b>活动安排</b></h2></div>
            <div class="text-muted" style="font-size: 20px;">
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tbody>
    ...
    <tr>
      <td>第5天</td>
      <td>12月25日</td>
      <td>广州 - 深圳<br>全天：太空科技南方研究院，晚餐品尝各类生猛海鲜</td>
      <td>早：酒店<br>午：社会餐厅<br>晚：社会餐厅</td>
      <td>深圳携程4钻</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>12月31日</td>
      <td>闭营仪式 + 送机</td>
      <td>早：酒店<br>午：社会餐厅<br>晚：海鲜大餐</td>
      <td>厦门携程4钻</td>
    </tr>
  </tbody>
</table>

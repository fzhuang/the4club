...
<div class="text-muted" style="font-size: 18px;">
 ...
 文化传承是一种记忆的延续，它将语言、艺术、习俗、信仰以及其他传统形式，通过代际的学习和实践保存下来。在海外中文教育的背景下，文化传承尤其重要。它不仅能够帮助海外华人后代保持对自身根源的认同，还能够将中华文化的精髓展示给更多国家和民族。比如，通过教授中文、传播中国书法、音乐、戏剧和民间艺术等形式，能够使不同文化背景的人感受到中国文化的魅力，并激发他们的兴趣与热爱。                               
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="page-section">
        <div class="container"> 
            <div>
	            <span style="color: #323edb; font-size: 18px;">加中文化教育交流中心</span>&nbsp;
            </div>
            <div class="row" style="margin: 20px 0 10px 0;">              
	            <div class="col-md-6 col-sm-6 col-xs-12">	                
	                <h1><b>文化传承和交流互动</b></h1>
	                <div class="text-muted" style="font-size: 20px; margin-top: 20px;">
	                    文化传承和交流互动是文化发展的两大核心支柱。它们不仅帮助个体找到文化身份的归属感，也通过文化的传播和碰撞，为社会注入了多样性与创造力。通过加中文化教育交流中心的努力，中国文化能够更好地扎根于加拿大多元文化的土壤之中，成为连接不同文化的一座桥梁和纽带。       
	                </div>
	            </div>

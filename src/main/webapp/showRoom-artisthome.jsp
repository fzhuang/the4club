...
<head>
	...
	<meta name="title" content="艺术家之家"/>
	<meta property="og:image" content="https://the4cclub.ca/the4club/resource/images/logo.png">
	<meta property="og:title" content="艺术家之家">
	<meta property="og:description" content="艺术家之家">
...
<div class="main"><!--main-->
  ...
  艺术家之家是艺术家的天地，在这里观众可以学习和欣赏艺术家的作品和风采。
                         </div>
                    </div>
                </div>
            </div>
    ...
    <section class="page-section" style="margin-top: 20px;">   
        <div class="container">
            <div>
                 <span style="color: #323edb; font-size: 18px;">艺术家的天地 · 灵感的源泉</span>&nbsp;
            </div>
            <div class="row" style="margin: 20px 0 10px 0;">              
                   <div class="text-muted">
					<div class="text-muted" style="font-size: 20px;">
 欢迎来到艺术家之家，这里是艺术创作者展示才华、分享灵感的空间。观众不仅可以欣赏到多位艺术家的精彩作品，更能深入了解他们背后的故事与创作历程。
<br/><br/>在这里，艺术不只是观赏，更是一种体验与交流。                     
                    </div>        
            </div>          
        </div>
        <hr>
    ...
    <section class="page-section" style="margin-top: 10px;">   
        <div class="container">
            ...
            <div><h2><b>书法家曲永仲</b></h2></div>           
            <div class="row" style="margin: 20px 0 10px 0;">              
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="text-muted">
						<div class="text-muted" style="font-size: 20px;">
曲永仲先生是加拿大著名的华人书法家，长期致力于书法艺术的创作与研究。他的作品被博物馆、美术馆、图书馆、政府机构和社会各界广泛收藏，并曾获得中国文化部“群星奖”以及加拿大联邦多元文化部的优秀艺术奖。
<br/><br/>
曲先生现为加拿大加华艺术协会终身荣誉会长、加拿大中华书画艺术联合会共同主席，以及加拿大中国书画院的艺术顾问。他在加拿大首都地区积极推动书画艺术的发展，组织和策划了多项艺术活动。						
						</div>                       
                    </div>

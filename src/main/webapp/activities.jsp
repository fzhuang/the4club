    ...
    <section class="activities-page">
        <div class="container">
            ...
            <ul class="activities-list">
                ...
                <li class="activities-item"><a href="2026Mother_zh.jsp"><i class="far fa-calendar-check"></i><span>Mother's Day Call for Submissions<span class="activities-tag">Community</span></span></a></li>
                <li class="activities-item"><a href="2026MotherActivities_zh.jsp"><i class="far fa-calendar-check"></i><span>May 9 Mother's Day Event<span class="activities-tag">Community</span></span></a></li>
                <li class="activities-item"><a href="2026-paintingByYoung_zh.jsp"><i class="far fa-calendar-check"></i><span>2026 第三届渥太华青少年生肖绘画比赛（马年）<span class="activities-tag">Competition</span></span></a></li>

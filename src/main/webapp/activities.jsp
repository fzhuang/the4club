    ...
    <section class="activities-page">
        <div class="container">
            ...
            <ul class="activities-list">
                <li class="activities-item"><a href="2026DragonBoatFatherDay.jsp"><i class="far fa-calendar-check"></i><span>Dragon Boat Festival Meets Father's Day Cultural Gathering<span class="activities-tag">Community</span></span></a></li>
                ...
                <li class="activities-item"><a href="2026-motherArtPoetry.jsp"><i class="far fa-calendar-check"></i><span>Mother's Day Art Exhibition and Poetry Recital<span class="activities-tag">Community</span></span></a></li>

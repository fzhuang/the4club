...
<head>
	...
	<link rel="canonical" href="https://the4cclub.ca/2026yxxSummer_zh.jsp"/>
...
报名截止时间：2026年5月31日。
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <img style="max-width: 90%" src="2026yxx/1.png" /> 
                </div>         
            </div>     
        </div>
        <hr>
    ...
    <section class="page-section">   
        <div class="container">
            ...
            <div class="row" style="margin: 20px 0 10px 0;">              
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/2.png" /> 
                </div>      
            </div>  
             <div class="row" style="margin: 10px 0 10px 0;">              
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/3.png" /> 
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/4.png" /> 
                </div>   
            </div> 
        </div>
        <hr>
    ...
    <section class="page-section">   
        <div class="container">
            ...
            <div class="row" style="margin: 20px 0 10px 0;">              
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/40.png" /> 
                </div>      
            </div>  
        </div>
        <hr>
            ...
            <table class="comparison" style="margin-top: 20px;">
                ...
                <tbody>
                    ...
                    <tr><th>成长价值</th><td>短期放松</td><td>长期文化视野+跨文化交流能力</td></tr>
                        ...
                        <div class="row" style="margin: 10px 0 10px 0;">              
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/61.png" /> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img style="max-width: 100%" src="2026yxx/62.png" /> 
                </div>   
            </div>
        </div>
        <hr>
    ...
    <section class="page-section">
        <div class="container">
            ...
            <div class="text-muted" style="font-size: 20px; margin-top: 10px;">
                ...
                报名链接: https://the4cclub.ca/the4club/2026yxxSummer_zh.jsp <br/>

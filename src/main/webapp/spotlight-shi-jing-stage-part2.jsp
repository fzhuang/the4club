...
<html lang="zh-CN">
<head>
    <title>4cClub: 97.9FM 渥太华中文电台：从上戏到渥太华——石静的人生与舞台（下）</title>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0"/>
    <meta name="title" content="97.9FM 渥太华中文电台：从上戏到渥太华——石静的人生与舞台（下）"/>
    ...
    <link rel="canonical" href="https://the4cclub.ca/spotlight-shi-jing-stage-part2.jsp"/>
        ...
        <div class="container">
            <div class="row" style="display:flex; align-items:center; flex-wrap:wrap;">
                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <h1>97.9FM 渥太华中文电台：从上戏到渥太华——石静的人生与舞台（下）</h1>
    ...
    <section class="page-section">
        <div class="container">
            <div class="lf-source">
                ...
                <a href="https://mp.weixin.qq.com/s/wW9MUMZaOjYvu0_in-A2ww" target="_blank">《从上戏到渥太华——石静的人生与舞台（下）》</a>。页面尽量保留原文采访段落、图片与问答内容；原文音频请通过微信文章收听。
            </div>
            <article class="lf-article">
                <%@ include file="/spotlight-shi-jing-stage-part2/article-content.jspf" %>
            </article>
        </div>
    </section>
